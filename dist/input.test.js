...
},{"./svg":15}],7:[function(require,module,exports) {
'use strict';
...
//
      ...
      if (typeof $3feeed === 'function') {
        ...
        Object.assign($3feeed, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wrapper",class:{error: _vm.error}},[_c('input',{attrs:{"type":"text","disabled":_vm.disabled,"readonly":_vm.readonly},domProps:{"value":_vm.value},on:{"change":function($event){_vm.$emit('change', $event.target.value)},"input":function($event){_vm.$emit('input', $event.target.value)},"focus":function($event){_vm.$emit('focus', $event.target.value)},"blur":function($event){_vm.$emit('blur', $event.target.value)}}}),_vm._v(" "),(_vm.error)?_c('tmplate',[_c('n-icon',{staticClass:"icon-error",attrs:{"name":"error"}}),_vm._v(" "),_c('span',{staticClass:"errorMessage"},[_vm._v(_vm._s(_vm.error))])],1):_vm._e()],1)}
var staticRenderFns = []
...
},{"./icon":13}],2:[function(require,module,exports) {
'use strict';
...
describe('Input', function () {
    ...
    it('存在.', function () {
        expect(_input2.default).to.exist;
    });

    describe('props', function () {
        var Constructor = _vue2.default.extend(_input2.default);
        var vm = void 0;
        afterEach(function () {
            vm.$destroy();
        });
